package com.lepine.transfers.controllers.converters;
...
// Copied from https://hugo-ma-alves.github.io/2020-02-01-json-patch-spring-application/
@Component
public class JsonPatchHttpMessageConverter extends AbstractHttpMessageConverter<JsonPatch> {
    ...
    protected void writeInternal(JsonPatch jsonPatch, HttpOutputMessage outputMessage) throws HttpMessageNotWritableException {
        throw new RuntimeException("The write Json patch is not implemented");
    }
