...
* The following dependencies are not known to work with Spring Native: 'Flyway Migration, Spring Configuration
...
```
$ docker run --rm -p 8080:8080 transfers:0.0.1-SNAPSHOT
```
